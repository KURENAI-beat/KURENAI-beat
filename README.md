...
- **所属**: 米子工業高等専門学校 情報システムコース
- **目標**: 堅牢で使いやすいサービスを支えるバックエンドエンジニア
- **興味・注力分野**:
  - サーバー・インフラ構築（自宅ファイルサーバーの運用経験あり）
  - AI関連技術・Webアプリケーション開発（PHP / Laravel）
  - モバイルアプリ開発（iOS / Swift）
- **趣味・特技**: Beatbox / ギター演奏 / 作曲 / イラスト制作
...
#### フレームワーク・環境・ツール (Frameworks & Tools)
<p>
